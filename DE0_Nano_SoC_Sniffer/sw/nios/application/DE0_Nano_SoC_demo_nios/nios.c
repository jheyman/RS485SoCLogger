...
void uart_putchar(void *base, int character)
{
    unsigned int status;
    ...
    do {
        ...
        {
          IOWR_FIFOED_AVALON_UART_TXDATA(base, (character & 0xff));
          //printf("Sent char [%c]\n", character);
          return;
        }
        //else
...
int uart_getchar(void *base, char* c)
{
    unsigned int status;
        ...
        {
          *c = IORD_FIFOED_AVALON_UART_RXDATA(base);
          return 0;
        }
        //else
...
/*
	   unsigned int status_uart0 =  IORD_FIFOED_AVALON_UART_STATUS(FIFOED_AVALON_UART_0_BASE);
	   //printf("read UART0 status = %X\n", status_uart0);

	   unsigned int status_uart1 =  IORD_FIFOED_AVALON_UART_STATUS(FIFOED_AVALON_UART_1_BASE);
	   //printf("read UART1 status = %X\n", status_uart1);

	   unsigned int status_uart2 =  IORD_FIFOED_AVALON_UART_STATUS(FIFOED_AVALON_UART_2_BASE);
	   //printf("read UART2 status = %X\n", status_uart2);

	   unsigned int status_uart3 =  IORD_FIFOED_AVALON_UART_STATUS(FIFOED_AVALON_UART_3_BASE);
	   //printf("read UART3 status = %X\n", status_uart3);
*/
...
/*
					alt_u32 fifo_write_fill_level = (
							IORD_ALTERA_MSGDMA_CSR_DESCRIPTOR_FILL_LEVEL(MSGDMADev->csr_base) &
							ALTERA_MSGDMA_CSR_WRITE_FILL_LEVEL_MASK) >>
							ALTERA_MSGDMA_CSR_WRITE_FILL_LEVEL_OFFSET;
					printf("mSGDMA FIFO level: %d\n", fifo_write_fill_level);
*/
